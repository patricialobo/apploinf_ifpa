...
public class GaleriaRefeitorioActivity extends Activity {

    ImageSwitcher is;

    Button anterior, avancar;

    Integer[] images = {R.drawable.planta_refeitorio, R.drawable.image_refeitorio, R.drawable.image_refeitorio1};
    ...
    protected void onCreate(Bundle savedIntanceState) {
        ...
        is.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                ...
                imageView.setImageResource(R.drawable.planta_refeitorio);
