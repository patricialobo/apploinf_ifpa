...
public class GaleriaAuditorioActivity extends Activity {

    ImageSwitcher is;

    Button anterior, avancar;

    Integer[] images = {R.drawable.planta_auditorio, R.drawable.image_auditorio, R.drawable.image_auditorio1};
    ...
    protected void onCreate(Bundle savedIntanceState) {
        ...
        is.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                ...
                imageView.setImageResource(R.drawable.planta_auditorio);
