...
public class GaleriaBiblioActivity extends Activity {

    ImageSwitcher is;

    Button anterior, avancar;

    Integer[] images = {R.drawable.planta_biblioteca, R.drawable.image_biblioteca1, R.drawable.image_bibioteca2};
    ...
    protected void onCreate(Bundle savedIntanceState) {
        ...
        is.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                ...
                imageView.setImageResource(R.drawable.planta_biblioteca);
